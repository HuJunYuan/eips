...
(function ($) {
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: false, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, dnd: false, data: null, queryParams: {}, formatter: function (node) {
            ...
            $.ajax({
                // 2017.08.16 Update By Youke json字符串转化
                //type: opts.method, url: opts.url, data: _1cc, dataType: "json", success: function (data) {
                type: opts.method, url: opts.url, data: JSON.stringify(_1cc), dataType: "json", success: function (data) {
                    _1cd(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.switchbutton = function (_4ae, _4af) {
        ...
        return this.each(function () {
            ...
            _48b(this);
            _4ab(this);
            // 2017.08.13 ADD BY YOUKE 增加Lable START
            if ($.fn.switchbutton.methods.extensionMethods) {
                $.fn.switchbutton.methods.extensionMethods(this);
            }
            // 2017.08.13 ADD BY YOUKE 增加Lable END
        });
    };
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, interval: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, deltaY: 0, novalidate: false, editable: true, disabled: false, readonly: false, validateOnCreate: true, validateOnBlur: false, events: {
            ...
            // 2017.08.13 ADD BY YOUKE 修改combox，datetimebox等取值不正确 START
            //return $(_4e7).val();
            var dom = $(_4e7);
            return dom.next().hasClass("textbox-value") ? dom.next().val() : dom.val();
            // 2017.08.13 ADD BY YOUKE 修改combox，datetimebox等取值不正确 END
...
(function ($) {
    ...
    function _6df(_7c2, _7c3, cb) {
        ...
        if (opts.pagination) {
            // 2017.08.16 Update By Youke 适应QureyModel
            //$.extend(_7c4, { page: opts.pageNumber || 1, rows: opts.pageSize });
            $.extend(_7c4, { PageIndex: opts.pageNumber || 1, PageSize: opts.pageSize });
        }
        if (opts.sortName) {
            // 2017.08.16 Update By Youke 适应QureyModel
            //$.extend(_7c4, { sort: opts.sortName, order: opts.sortOrder });
            $.extend(_7c4, { SortField: opts.sortName, SortOrder: opts.sortOrder });
        }
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 24, headerEvents: { mouseover: _6ae(true), mouseout: _6ae(false), click: _6b2, dblclick: _6b7, contextmenu: _6ba }, rowEvents: { mouseover: _6bc(true), mouseout: _6bc(false), click: _6c3, dblclick: _6cd, contextmenu: _6d1 }, rowStyler: function (_86c, _86d) {
            ...
            $.ajax({
                ...
                type: opts.method, url: opts.url, data: JSON.stringify(_86e), dataType: "json", success: function (data) {
                    _86f(data);
                }, error: function () {
