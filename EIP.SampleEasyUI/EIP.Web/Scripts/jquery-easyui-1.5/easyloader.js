...
(function () {
    using(App.getUrl('Scripts/jquery-easyui-1.5/plugins/jeasyui.extensions.tree.dataPlain.js'));

    using(App.getUrl('Scripts/jquery-easyui-1.5/plugins/jeasyui.extensions.form.getData.js'));
});